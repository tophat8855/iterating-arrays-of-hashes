...
describe Dogs do
  ...
  describe "#find_by_owner" do
    xit "finds a dog by owner's first name" do
    ...
    xit "finds a dog by owner's last name" do
    ...
    xit "finds a dog by owner's full name" do
    ...
    xit "returns nothing if no owner is found" do
      expect(dogs.find_by_owner("Some Name")).to eq([])
    end
  end

  describe "#change_owner" do
    xit "changes an owner based on first name" do
      # fill me in!
    end

    xit "changes the owner based on last name" do
      # fill me in!
    end

    xit "changes the owner based on a full name" do
      # fill me in!
    end

    xit "doesn't change the owner if no owner is found" do
      # fill me in!
    end
  end
